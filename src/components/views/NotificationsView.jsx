  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="rounded-xl border border-dashed border-border p-16 text-center">
        ...
        <h3 className="text-sm font-bold text-foreground">TODO: Implement notifications API endpoint</h3>
        <p className="text-xs text-muted-foreground mt-1 max-w-md mx-auto leading-relaxed">
          Every number visible in the dashboard must come from backend APIs. Since administrative notifications are not supported by the original Express backend routes, this view is suspended until the API is implemented.
        </p>
        <div className="mt-4 text-[10px] font-semibold text-muted-foreground bg-muted/30 px-3 py-1.5 rounded-lg border border-border inline-block">
          File reference: <span className="font-mono">src/components/views/NotificationsView.jsx</span>
        </div>
      </div>
    </div>
  );
